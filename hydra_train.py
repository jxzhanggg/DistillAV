...
from train import main as pre_main
...
fariseq_root = "/home3/asrprg/jxzhang46/Documents/fairseq-master/fairseq"
@hydra.main(config_path=os.path.join(fariseq_root, "config"), config_name="config")
...
def cli_main():
    ...
    hydra_init(cfg_name)
    print('hydra.file', hydra.__file__)
    hydra_main()
